...
const (
	...
	TenantServiceName = "paastry.v1.TenantService"
)
...
const (
	...
	// CreateTenant RPC.
	TenantServiceCreateTenantProcedure = "/paastry.v1.TenantService/CreateTenant"
	// TenantServiceGetTenantProcedure is the fully-qualified name of the TenantService's GetTenant RPC.
	TenantServiceGetTenantProcedure = "/paastry.v1.TenantService/GetTenant"
	// TenantServiceListTenantsProcedure is the fully-qualified name of the TenantService's ListTenants
	// RPC.
	TenantServiceListTenantsProcedure = "/paastry.v1.TenantService/ListTenants"
)

// TenantServiceClient is a client for the paastry.v1.TenantService service.
...
// NewTenantServiceClient constructs a client for the paastry.v1.TenantService service. By default,
...
func NewTenantServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TenantServiceClient {
	...
	tenantServiceMethods := v1.File_paastry_v1_tenants_proto.Services().ByName("TenantService").Methods()
...
// CreateTenant calls paastry.v1.TenantService.CreateTenant.
...
// GetTenant calls paastry.v1.TenantService.GetTenant.
...
// ListTenants calls paastry.v1.TenantService.ListTenants.
...
// TenantServiceHandler is an implementation of the paastry.v1.TenantService service.
...
func NewTenantServiceHandler(svc TenantServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/paastry.v1.TenantService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTenantServiceHandler) CreateTenant(context.Context, *connect.Request[v1.CreateTenantRequest]) (*connect.Response[v1.CreateTenantResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("paastry.v1.TenantService.CreateTenant is not implemented"))
}
...
func (UnimplementedTenantServiceHandler) GetTenant(context.Context, *connect.Request[v1.GetTenantRequest]) (*connect.Response[v1.GetTenantResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("paastry.v1.TenantService.GetTenant is not implemented"))
}
...
func (UnimplementedTenantServiceHandler) ListTenants(context.Context, *connect.Request[v1.ListTenantsRequest]) (*connect.Response[v1.ListTenantsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("paastry.v1.TenantService.ListTenants is not implemented"))
}
